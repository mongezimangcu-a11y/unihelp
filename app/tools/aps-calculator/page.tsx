...
> = {
  ...
  uj: {
    ...
    countMode: 6,
    defaultDegree: "commerce",
    note: "Preset applies: best 6 subjects counted, LO usually excluded (general guideline).",
  },
  stellenbosch: {
    label: "Stellenbosch",
    includeLO: false,
  ...
  ukzn: {
    ...
    includeLO: true,
    countMode: 6,
    defaultDegree: "healthSciences",
    note: "Preset applies: best 6 subjects counted, LO may be included depending on programme (general guideline).",
  },
  ufs: {
    label: "UFS",
    includeLO: true,
    countMode: 6,
    defaultDegree: "education",
    note: "Preset applies: best 6 subjects counted, LO may be included (general guideline).",
  },
  nwu: {
    label: "NWU",
    includeLO: true,
  ...
  unisa: {
    ...
    countMode: 6,
    defaultDegree: "humanities",
    note: "Preset applies: best 6 subjects counted, LO may be included depending on qualification (general guideline).",
  },
  tut: {
    label: "TUT",
    includeLO: true,
    ...
    <main className="article">
      ...
      <section style={{ marginTop: 18 }}>
        <div className="card card--soft">
          ...
          <p>APS usually turns each matric mark into a point value. A common table is:</p>
